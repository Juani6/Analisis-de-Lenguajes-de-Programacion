...
pExp (VarInc a)  = pVar a <> text "++"
pExp (VarDec a)  = pVar a <> text "--"
pExp _ =
  error
    "El Pretty Printer SI está implementado para las extensiones del Ejercicio 1, pero no se entiende que estas queriendo poner."
